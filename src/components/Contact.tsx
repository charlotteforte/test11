...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20" style={{ background: 'linear-gradient(180deg, #F7FAFF 0%, #E0E0E0 15%, #c1c7d0 30%, #a1a8b5 45%, #898F9B 60%, #6b7280 75%, #4a5568 90%, #2d3a4f 100%)' }}>

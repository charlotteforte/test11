...
const Contact = () => {
  ...
  return (
    <section id="contact" className="py-20" style={{ background: 'linear-gradient(180deg, #f3f4f6 0%, #d1d5db 15%, #a1a8b5 30%, #898F9B 45%, #6b7280 60%, #4b5563 75%, #374151 90%, #1f2937 100%)' }}>

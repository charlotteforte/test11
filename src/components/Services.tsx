...
const Services = () => {
  ...
  return (
    <section id="services" className="py-20" style={{ background: 'linear-gradient(180deg, #4b5563 0%, #5a6478 15%, #6b7280 30%, #737a85 45%, #7a8189 60%, #898F9B 75%, #9ba1ab 85%, #a1a8b5 100%)' }}>
